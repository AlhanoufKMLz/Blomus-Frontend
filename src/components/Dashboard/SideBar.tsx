    ...
    <div>
      <nav className="fixed px-3">
        <div
          className={
            isOpen
              ? 'absolute shadow-md inset-x-0 h-screen w-fit py-4 px-2 transition-all duration-300 ease-in-out text-primary_grey bg-primary_pink'
              : 'absolute shadow-md inset-x-0 h-screen w-20 py-4 px-2 transition-all duration-300 ease-in-out text-primary_grey bg-primary_pink'
          }>
