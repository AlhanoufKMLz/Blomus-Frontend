        ...
        <div className="px-6 py-8 mx-auto">
          ...
          <div className="flex flex-col items-center md:flex-row md:justify-between">
            ...
            <div className="flex -mx-2">
              <a
                href="#"
                className="mx-2 text-[#D0CDD3] transition-colors duration-300 hover:text-[#be9995]"
                aria-label="Reddit">
                <svg
              ...
              <a
                href="#"
                className="mx-2 transition-colors duration-300 hover:text-[#be9995]"
                aria-label="Facebook">
                <svg
                  className="w-5 h-5 fill-current"
                  viewBox="0 0 24 24"
              ...
              <a
                href="#"
                className="mx-2transition-colors duration-300 hover:text-[#be9995]"
                aria-label="Github">
                <svg
                  className="w-5 h-5 fill-current"
                  viewBox="0 0 24 24"
